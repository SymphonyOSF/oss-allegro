...
import com.symphony.oss.models.core.canon.facade.EncryptedRecord;
...
/**
 * A builder and encryptor for arbitrary string data.
 * 
 * @author Bruce Skingle
 *
 */
public class EncryptedRecordBuilder extends EncryptablePayloadBuilder<EncryptedRecordBuilder, IEncryptedRecord>
{
  protected final EncryptedRecord.Builder builder_ = new EncryptedRecord.Builder();
  protected final IAllegro2Api            cryptoClient_;
  
  private String payload_;
  
  protected EncryptedRecordBuilder(IAllegro2Api cryptoClient)
  {
    super(EncryptedRecordBuilder.class);
   ...
   */
  public EncryptedRecordBuilder withThreadId(ThreadId threadId)
  {
  ...
  @Override
  protected EncryptedRecordBuilder withEncryptedPayload(
      EncryptedData value)
  {
  ...
  @Override
  protected EncryptedRecordBuilder withCipherSuiteId(
      CipherSuiteId value)
  {
  ...
  @Override
  protected EncryptedRecordBuilder withRotationId(RotationId value)
  {
   ...
   * @return This (fluent method).
   */
  public EncryptedRecordBuilder withPayload(String payload)
  {
    payload_ = payload;
  ...
  @Override
  protected IEncryptedRecord construct()
  {
  ...
  protected ImmutableByteArray getPayload()
  {
    ...
    return ImmutableByteArray.newInstance(payload_);
  }
}