 ...
 */
@FunctionalInterface
public interface IAbstractApplicationObjectConsumer<H extends IApplicationObjectHeader, P extends IApplicationObjectPayload>
{
    /**
     * Consume the given decrypted record.
     *
     * @param storedObject the object as stored (with encrypted payload). 
     * @param header the unencrypted header.
     * @param payload the decrypted payload.
     */
    void accept(IStoredApplicationObject storedObject, H header, P payload);
}