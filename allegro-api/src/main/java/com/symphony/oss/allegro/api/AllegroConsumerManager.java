...
public class AllegroConsumerManager
{
  ...
  private final Allegro2Decryptor                               allegroDecryptor_;
  ...
  {
    private final Allegro2Decryptor                      decryptor_;
    private final IModelRegistry                        modelRegistry_;
    ...
    AbstractBuilder(Class<T> type, Allegro2Decryptor decryptor, IModelRegistry modelRegistry)
    {
      super(type);
...
//      faultAccumulator.checkNotNull(decryptor_,  "Decryptor");
  ...
  {
    public Builder(Allegro2Decryptor allegroDecryptor, IModelRegistry modelRegistry)
    {
